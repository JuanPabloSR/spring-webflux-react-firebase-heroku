...
class IncreaseUseCaseTest {
    ...
    public void increase()
    {
        ...
        var answerVotedDown = new IncreaseUseCase(getAnswerUseCase,updateAnswerUseCase, calculateAnswerPositionsUseCase, mapperUtils);

        StepVerifier.create(answerVotedDown.apply("xxxx", "uuuu"))
                .verifyComplete();
    }
